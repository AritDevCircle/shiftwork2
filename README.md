...
5. Add `database.yml` file to `config` folder.  Here is the code for your local [config/database.yml](https://gist.github.com/msarit/6ec31a5c1feef81ce44d3810bf58cdfd) file
